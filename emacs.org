...
#+begin_src emacs-lisp
(use-package consult-icons
  :after consult
  :hook (consult-mode . consult-icons-mode))
#+end_src
...
(set-face-attribute 'font-lock-function-name-face nil
                    :foreground "#B58EAE" :weight 'normal) 
(custom-set-faces
...
(custom-set-faces
 '(rainbow-delimiters-depth-1-face ((t (:foreground "#b48ead"))))  ; ;; 81A1C1 for blue
 '(rainbow-delimiters-depth-2-face ((t (:foreground "#a3be8c"))))  ; green
 '(rainbow-delimiters-depth-3-face ((t (:foreground "#88c0d0"))))  ; blue
...
;; Install indent-bars if not already installed
;; Install indent-bars if not already installed
...
#+end_src
(treesit-query-validate 'tsx-ts-mode) 
